        ...
        <>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6 ftco-animate pr-lg-5">
                            ...
                            >
                                <Link to="/donate" className="btn px-5 py-3 font-weight-bold" style={{ backgroundColor: '#dc2626', color: '#fff', fontSize: '15px', borderRadius: '14px', border: 'none' }}>{t('impact_page.btn_donate')}</Link>
                            </motion.p>
                        </div>
                        ...
                        >
                            <div className="h-100 d-flex flex-column" style={{
                                ...
                                <div className="mt-auto">
                                    ...
                                    <Link to="/resources" className="btn btn-primary w-100 py-3 mt-4 border-0 font-weight-bold" style={{ backgroundColor: '#122f2b', borderRadius: '14px', fontSize: '15px', letterSpacing: '0.5px' }}>
            ...
            <div className="modal fade" id="donateModal" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content border-0 rounded-2xl p-4 dark:bg-slate-900" style={{ borderRadius: '30px' }}>
                        <div className="modal-header border-0 pb-0">
                            <h5 className="text-2xl font-bold dark:text-white">{t('impact_page.donate_now_heading')}</h5>
                            <button type="button" className="close dark:text-white" data-dismiss="modal" aria-label="Close">
